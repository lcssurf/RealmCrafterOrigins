...
## Corpus Check
- 2500 files · ~10,479,642 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16840 nodes · 31384 edges · 863 communities detected
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 3768 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7eb35b19`
...
1. `Assert()` - 287 edges
2. `DeadlyImportError()` - 243 edges
3. `_glfwInputError()` - 128 edges
4. `DB` - 73 edges
5. `begin()` - 69 edges
6. `nk_strlen()` - 64 edges
7. `ClientConn` - 63 edges
8. `AiMesh` - 59 edges
9. `main()` - 54 edges
10. `nk_vec2()` - 50 edges

## Surprising Connections (you probably didn't know these)
- `ShouldClose()` --calls--> `glfwWindowShouldClose()`  [INFERRED]
  client/src/core/window.cpp → SkeletalAnimation-master/lib/glfw/src/window.c
- `EndFrame()` --calls--> `glfwSwapBuffers()`  [INFERRED]
  client/src/core/window.cpp → SkeletalAnimation-master/lib/glfw/src/context.c
...
## Communities (2235 total, 270 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (142): nk_buffer_memory_const(), nk_button_image_label(), nk_button_image_text(), nk_button_symbol_label(), nk_button_symbol_text(), nk_chart_add_slot(), nk_chart_add_slot_colored(), nk_check_flags_label() (+134 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (136): dump(), getBool(), getDouble(), getFloat(), getInt16(), getInt32(), getInt64(), getInt8() (+128 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (168): vec<2, T, Q> wx(), vec<2, T, Q> wy(), vec<2, T, Q> wz(), vec<2, T, Q> xw(), vec<2, T, Q> yw(), vec<2, T, Q> yx(), vec<2, T, Q> yy(), vec<2, T, Q> yz() (+160 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (168): vec<2, T, Q> ww(), vec<2, T, Q> xx(), vec<2, T, Q> xy(), vec<2, T, Q> xz(), vec<2, T, Q> zx(), vec<2, T, Q> zy(), vec<3, T, Q> wwx(), vec<3, T, Q> wwz() (+160 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (143): ActivateItem(), AddInputCharacter(), AddInputCharactersUTF8(), BeginGroup(), BringWindowToDisplayBack(), Build(), BuildSortByKey(), CalcItemSize() (+135 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (104): Realloc(), glfwExtensionSupported(), glfwGetProcAddress(), _glfwIsValidContextConfig(), _glfwRefreshContextAttribs(), _glfw_strdup(), _glfwInputError(), _glfwInputCursorPos() (+96 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (120): BeginFrame(), Window(), getopt(), getopt_long(), mat4x4_identity(), mat4x4_ortho(), mat4x4_translate(), nk_glfw3_device_upload_atlas() (+112 more)
...
Cohesion: 0.04
Nodes (104): GetInputTextState(), AlignTextToFramePadding(), BeginMainMenuBar(), BeginMenuBar(), BeginViewportSideBar(), Bullet(), BulletText(), BulletTextV() (+96 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (81): CalculateOptimalEdits(), CreateUnifiedDiff(), TestCase(), AddFailureHelper(), AddFatalFailure(), AddNonfatalFailure(), AnotherSubClassOfTest, AssertionResult (+73 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (78): AddTestInfo(), Append(), ArrayAsVector(), ChopLowBits(), Clear(), ClearResult(), ClearTestPartResults(), CodePointToUtf8() (+70 more)
...
Cohesion: 0.05
Nodes (96): nk_button_behavior(), nk_button_color(), nk_button_image(), nk_button_image_styled(), nk_button_image_text_styled(), nk_button_label_styled(), nk_button_symbol(), nk_button_symbol_styled() (+88 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (86): AddTexture(), ApplyVertexToEffectSemanticMapping(), BuildCamerasForNode(), BuildHierarchy(), BuildLightsForNode(), BuildMaterials(), BuildMeshesForNode(), ColladaLoader() (+78 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (64): _glfwInputMonitorWindow(), _glfwPlatformGetMonitorWorkarea(), _glfwRestoreVideoModeX11(), acquireMonitor(), convertLatin1toUTF8(), decodeUTF8(), disableCursor(), disableRawMouseMotion() (+56 more)
...
Cohesion: 0.05
Nodes (72): nk_glfw3_clipboard_copy(), nk_glfw3_clipboard_paste(), adjust_grid(), calc_grid(), cursor_position_callback(), draw_scene(), framebuffer_size_callback(), init_grid() (+64 more)
...
Cohesion: 0.05
Nodes (79): nk_add_value(), nk__begin(), nk_begin_titled(), nk_build(), nk_button_image_label_styled(), nk_button_symbol_label_styled(), nk_check_label(), nk_combo_begin_image_label() (+71 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (54): GetKeyState(), _glfwInputDrop(), _glfwRestoreVideoModeWin32(), acquireMonitor(), applyAspectRatio(), chooseImage(), createIcon(), createNativeWindow() (+46 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (69): AddBoundsToLML(), AddIntersectNode(), AddPolygon(), AddPolygons(), AppendPolygon(), Area(), BuildArc(), BuildIntersectList() (+61 more)
...
Cohesion: 0.09
Nodes (10): buildFramedPacket(), isClosedErr(), musicForArea(), resultMessage(), ClientConn, NewReader(), ProcessXP(), StatsByLevel() (+2 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (68): BeginChildEx(), BringWindowToDisplayFront(), BringWindowToFocusFront(), CalcResizePosSizeFromAnyCorner(), ClearActiveID(), CloseCurrentPopup(), ClosePopupsOverWindow(), ClosePopupToLevel() (+60 more)
...
Cohesion: 0.13
Nodes (64): ColladaParser(), CopyVertex(), ExtractDataObjectFromChannel(), GetAttribute(), GetTextContent(), GetTypeForSemantic(), PostProcessControllers(), PostProcessRootAnimations() (+56 more)

### Community 26 - "Community 26"
Cohesion: 0.07
Nodes (53): def_free_func(), mz_compress(), mz_compress2(), mz_compressBound(), mz_crc32(), mz_deflate(), mz_deflateBound(), mz_deflateEnd() (+45 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (65): nk_do_edit(), nk_edit_draw_text(), nk_input_char(), nk_input_glyph(), nk_input_unicode(), nk_is_word_boundary(), nk_str_append_str_char(), nk_str_append_str_runes() (+57 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (42): ApplyTonemapping(), CreateFramebuffers(), CreateVAO(), DrawPbrSphereGrid(), DrawUI(), InitGL(), InitImGui(), InitScene() (+34 more)

### Community 30 - "Community 30"
Cohesion: 0.07
Nodes (47): CopyAndAdvance(), GetF4(), GetPtr(), GetU1(), GetU2(), GetU4(), SetCurrentPos(), SetPtr() (+39 more)
...
Cohesion: 0.04
Nodes (36): EndFrame(), SetTitle(), ShouldClose(), nk_glfw3_mouse_button_callback(), key_callback(), key_callback(), key_callback(), mouse_button_callback() (+28 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (40): CanRead(), CanRead(), CanRead(), CanRead(), CanRead(), CanRead(), CanRead(), CanRead() (+32 more)
...
Cohesion: 0.07
Nodes (61): nk_buffer_align(), nk_buffer_alloc(), nk_buffer_mark(), nk_buffer_memory(), nk_buffer_push(), nk_buffer_realloc(), nk_buffer_reset(), nk_buffer_total() (+53 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (20): acquireMonitor(), applySizeLimits(), createNativeWindow(), fitToMonitor(), _glfwPlatformCreateWindow(), _glfwPlatformDestroyWindow(), _glfwPlatformFocusWindow(), _glfwPlatformIconifyWindow() (+12 more)
...
Cohesion: 0.06
Nodes (46): _glfw_fmaxf(), _glfw_fminf(), glfwInitHint(), glfwGetGamepadState(), _glfwAllocGammaArrays(), _glfwAllocMonitor(), _glfwChooseVideoMode(), _glfwFreeGammaArrays() (+38 more)

### Community 44 - "Community 44"
Cohesion: 0.08
Nodes (51): resample_row_1(), stbi__convert_16_to_8(), stbi__convert_8_to_16(), stbi_convert_iphone_png_to_rgb(), stbi_failure_reason(), stbi__float_postprocess(), stbi__fopen(), stbi_hdr_to_ldr_scale() (+43 more)
...
Cohesion: 0.07
Nodes (31): ConvertMaterial(), ConvertObjectSection(), GetNextLine(), InternReadFile(), LoadObjectSection(), TextFileToBuffer(), InternReadFile(), BuildGraph() (+23 more)
...
Cohesion: 0.05
Nodes (49): nk_glfw3_shutdown(), nk_buffer_clear(), nk_buffer_free(), nk_buffer_init(), nk_buffer_init_fixed(), nk_clear(), nk_edit_buffer(), nk_edit_string() (+41 more)
...
Cohesion: 0.07
Nodes (23): main(), GetType(), restructure(), Structify(), Agent, aNode, aPQ, NavMesh (+15 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (48): AddTestPartResult(), AppendUserMessage(), ColoredPrintf(), current_test_result(), CurrentOsStackTraceExceptTop(), CurrentStackTrace(), FilterTests(), FormatCxxExceptionMessage() (+40 more)
...
Cohesion: 0.09
Nodes (35): MD5AnimParser(), MD5CameraParser(), MD5MeshParser(), MD5Parser(), ParseHeader(), ParseSection(), ReportError(), ReportWarning() (+27 more)
...
Cohesion: 0.11
Nodes (41): AddTextureMem(), ChooseBGColor(), ClearBG(), ClearHistory(), DisplayColorDialog(), DisplayMemoryConsumption(), DoExport(), HandleCommandLine() (+33 more)
...
Cohesion: 0.07
Nodes (27): mat4x4_add(), mat4x4_arcball(), mat4x4_dup(), mat4x4_from_vec3_mul_outer(), mat4x4_look_at(), mat4x4_mul(), mat4x4_orthonormalize(), mat4x4_perspective() (+19 more)
...
Cohesion: 0.07
Nodes (35): _glfwChooseFBConfig(), _glfwStringInExtensionString(), chooseEGLConfig(), extensionSupportedEGL(), getEGLConfigAttrib(), getEGLErrorString(), _glfwChooseVisualEGL(), glfwGetEGLContext() (+27 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (43): AddDrawListToDrawData(), AddRootWindowToDrawData(), AddWindowToDrawData(), BeginDragDropTargetCustom(), ClearIniSettings(), ColorConvertRGBtoHSV(), DebugNodeDrawCmdShowMeshAndBoundingBox(), DebugNodeDrawList() (+35 more)
...
Cohesion: 0.09
Nodes (30): AddChild(), AddVertexMapping(), AssociatedVertexData(), BoneAssignmentsForVertex(), BoneById(), BoneByName(), CalculateWorldMatrixAndDefaultPose(), ComponentCount() (+22 more)
...
Cohesion: 0.11
Nodes (35): Assimp(), fast_atof(), createMaterial(), getColorRGBA(), getFloatValue(), getIlluminationModel(), getTexture(), getTextureOption() (+27 more)
...
Cohesion: 0.09
Nodes (40): disabled_test_count(), elapsed_time(), Failed(), failed_test_count(), FormatCountableNoun(), FormatTestCaseCount(), FormatTestCount(), FormatTimeInMillisAsSeconds() (+32 more)
...
Cohesion: 0.08
Nodes (41): nk_font_atlas_bake(), nk_font_bake(), nk_font_bake_convert(), nk_font_bake_custom_data(), nk_font_bake_pack(), nk_font_baker(), nk_font_baker_memory(), nk_font_find_glyph() (+33 more)

### Community 77 - "Community 77"
Cohesion: 0.06
Nodes (39): nk_chart_begin(), nk_chart_end(), nk_chart_push(), nk_chart_push_column(), nk_chart_push_slot(), nk_draw_text(), nk_label_colored(), nk_label_colored_wrap() (+31 more)

### Community 78 - "Community 78"
Cohesion: 0.07
Nodes (30): AutoHandle(), Abort(), AssertHeld(), AutoHandle(), BoolFromGTestEnv(), CapturedStream, FlagToEnvVar(), FullMatch() (+22 more)
...
Cohesion: 0.09
Nodes (39): FocusableItemRegister(), FocusableItemUnregister(), ImAtof(), TempInputIsActive(), IsMouseDragPastThreshold(), LogSetNextTextDecoration(), ButtonEx(), DataTypeApplyOpFromText() (+31 more)

### Community 84 - "Community 84"
Cohesion: 0.09
Nodes (31): equal(), my_stbtt_initfont(), my_stbtt_print(), stbrp_init_target(), stbrp_pack_rects(), stbtt__add_point(), stbtt_BakeFontBitmap(), stbtt__compute_crossings_x() (+23 more)

### Community 85 - "Community 85"
Cohesion: 0.09
Nodes (36): stbi__clamp(), stbi__compute_transparency(), stbi__compute_transparency16(), stbi__compute_y_16(), stbi__convert_format16(), stbi__cpuid3(), stbi__de_iphone(), stbi__do_png() (+28 more)

### Community 86 - "Community 86"
Cohesion: 0.07
Nodes (17): AddNodeWeight(), ApplyCustomizedPostProcessing(), ApplyPostProcessing(), FreeScene(), GetExtensionList(), GetImporter(), GetImporterIndex(), GetMemoryRequirements() (+9 more)

### Community 88 - "Community 88"
Cohesion: 0.06
Nodes (8): Node::Dump(), Node::WritePropertyNode(), Node::WritePropertyNodeAscii(), Node::WritePropertyNodeBinary(), DumpAscii(), DumpBinary(), FBXExportProperty(), size()
...
Cohesion: 0.07
Nodes (38): ImAtan2(), ButtonBehavior(), Checkbox(), CheckboxFlags(), CheckboxFlagsT(), CloseButton(), CollapseButton(), CollapsingHeader() (+30 more)

### Community 91 - "Community 91"
Cohesion: 0.14
Nodes (33): BuildNodes(), chunk_guard, ConvertTexture(), InternReadFile(), ReadAsciiFile(), ReadBasicNodeInfo_Ascii(), ReadBasicNodeInfo_Binary(), ReadBinaryFile() (+25 more)
...
Cohesion: 0.07
Nodes (12): a(), a5(), b(), bF(), bj(), bv(), C(), G() (+4 more)
...
Cohesion: 0.11
Nodes (18): Area, broadcastNPCPosition(), endChase(), leashNPC(), moveNPCToward(), pickWanderTarget(), postChaseMode(), startWander() (+10 more)
...
Cohesion: 0.08
Nodes (25): choosePixelFormat(), findPixelFormatAttribValue(), _glfwCreateContextWGL(), glfwGetWGLContext(), _glfwInitWGL(), _glfwTerminateWGL(), makeContextCurrentWGL(), swapBuffersWGL() (+17 more)
...
Cohesion: 0.07
Nodes (36): nk_chart_push_line(), nk_color_pick(), nk_color_picker(), nk_command_buffer_push(), nk_cos(), nk_do_color_picker(), nk_draw_color_picker(), nk_draw_list_init() (+28 more)
...
Cohesion: 0.11
Nodes (35): AddEdgeToSEL(), AddHorzJoin(), AddJoin(), AddLocalMaxPoly(), AddLocalMinPoly(), AddOutPt(), CreateOutRec(), DeleteFromAEL() (+27 more)
...
Cohesion: 0.06
Nodes (33): Account, ActorDef, ActorDefAnim, ActorDefMesh, AreaConfig, AreaPortal, AreaSoundZone, AreaTrigger (+25 more)

### Community 112 - "Community 112"
Cohesion: 0.12
Nodes (18): CreateAnimation(), GetNextToken(), GetNextTokenAsFloat(), InternReadFile(), ReadEndSite(), ReadHierarchy(), ReadMotion(), ReadNode() (+10 more)

### Community 113 - "Community 113"
Cohesion: 0.08
Nodes (20): _glfwInputChar(), _glfwInputCursorEnter(), _glfwInputKey(), _glfwInputMouseClick(), _glfwPlatformHideWindow(), _glfwInputWindowFocus(), composeSymbol(), createKeyTables() (+12 more)

### Community 114 - "Community 114"
Cohesion: 0.08
Nodes (31): AddBezierCurve(), AddCustomRectFontGlyph(), AddLine(), AddQuad(), AddQuadFilled(), AddRanges(), AddTriangle(), BuildRanges() (+23 more)

### Community 115 - "Community 115"
Cohesion: 0.1
Nodes (25): AddBezierCubic(), AddBezierQuadratic(), AddFont(), AddTriangleFilled(), Clear(), ClearFonts(), _ClearFreeMemory(), ClearInputData() (+17 more)

### Community 116 - "Community 116"
Cohesion: 0.14
Nodes (33): stbi__at_eof(), stbi__build_fast_ac(), stbi__build_huffman(), stbi__copyval(), stbi__decode_jpeg_header(), stbi__decode_jpeg_image(), stbi__get16be(), stbi__get32be() (+25 more)
...
Cohesion: 0.07
Nodes (18): AddChar(), delete(), GetBit(), GetCustomRectByIndex(), ImDrawList(), ImGuiListClipper(), ImU32(), index_from_ptr() (+10 more)
...
Cohesion: 0.07
Nodes (16): AddLoadRequest(), ConvertToUTF8(), LoadAll(), LoadRequest(), ReadFile(), SetupProperties(), SimpleExtensionCheck(), UpdateImporterScale() (+8 more)
...
Cohesion: 0.1
Nodes (19): compareVideoModes(), _glfwCompareVideoModes(), _glfwSplitBPP(), createMonitor(), _glfwGetMonitorContentScaleWin32(), _glfwPlatformGetMonitorContentScale(), _glfwPlatformGetVideoMode(), _glfwPlatformGetVideoModes() (+11 more)

### Community 125 - "Community 125"
Cohesion: 0.11
Nodes (31): stbi__addsizes_valid(), stbi__bmp_test(), stbi__convert_format(), stbi__create_png_image(), stbi__create_png_image_raw(), stbi__do_png(), stbi__getn(), stbi__gif_load() (+23 more)

### Community 126 - "Community 126"
Cohesion: 0.13
Nodes (31): main(), stbtt_BakeFontBitmap_internal(), stbtt_FindGlyphIndex(), stbtt_GetCodepointBitmapBox(), stbtt_GetCodepointBitmapBoxSubpixel(), stbtt_GetCodepointHMetrics(), stbtt_GetCodepointKernAdvance(), stbtt_GetFontBoundingBox() (+23 more)

### Community 127 - "Community 127"
Cohesion: 0.07
Nodes (13): c_str(), contains(), erase(), erase_unsorted(), find(), find_erase(), find_erase_unsorted(), front() (+5 more)

### Community 128 - "Community 128"
Cohesion: 0.14
Nodes (29): Draw(), EditTableColumnsFlags(), EditTableSizingFlags(), ExampleAppDocuments(), HelpMarker(), MyDocument(), NotifyOfDocumentsClosedElsewhere(), PopStyleCompact() (+21 more)

### Community 129 - "Community 129"
Cohesion: 0.1
Nodes (23): getCustomDataLayer(), getCustomDataLayerData(), isValidCustomDataType(), read(), readCustomData(), AddBlendParams(), AddSentinelTexture(), Assimp() (+15 more)
...
Cohesion: 0.07
Nodes (12): keypress_cb(), mouse_button_cb(), SetCursorVisible(), Update(), glfwGetMouseButton(), glfwSetInputMode(), hideMouseCursor(), showMouseCursor() (+4 more)
...
Cohesion: 0.1
Nodes (19): AppendToken(), BeginValue(), CreateSchemaValidator(), DestroryHasher(), DestroySchemaValidator(), EndValue(), FindPropertyIndex(), FreeState() (+11 more)
...
Cohesion: 0.14
Nodes (27): count_deformers(), count_images(), count_nodes(), count_textures(), ExportAscii(), ExportBinary(), ExportSceneFBX(), ExportSceneFBXA() (+19 more)

### Community 146 - "Community 146"
Cohesion: 0.14
Nodes (23): AnimationCurve(), AnimationCurveNode(), AnimationLayer(), AnimationStack(), Nodes(), DestinationObject(), Document(), Get() (+15 more)
...
Cohesion: 0.13
Nodes (28): stbi__at_eof(), stbi__bitcount(), stbi__bmp_load(), stbi__bmp_parse_header(), stbi__bmp_test_raw(), stbi__copyval(), stbi__get16le(), stbi__get32le() (+20 more)

### Community 152 - "Community 152"
Cohesion: 0.1
Nodes (28): append(), appendf(), BeginDragDropSource(), BeginDragDropTarget(), CreateNewWindowSettings(), FindOrCreateWindowSettings(), FindSettingsHandler(), FindWindowSettings() (+20 more)

### Community 153 - "Community 153"
Cohesion: 0.16
Nodes (25): AddSampler(), CopyValue(), ExportAnimations(), ExportData(), ExportMaterials(), ExportMeshes(), ExportMetadata(), ExportNode() (+17 more)
...
Cohesion: 0.13
Nodes (27): mz_zip_dos_to_time_t(), mz_zip_reader_extract_file_to_heap(), mz_zip_reader_extract_to_callback(), mz_zip_reader_extract_to_file(), mz_zip_reader_extract_to_heap(), mz_zip_reader_extract_to_mem(), mz_zip_reader_extract_to_mem_no_alloc(), mz_zip_reader_file_stat() (+19 more)
...
Cohesion: 0.1
Nodes (26): BeginChild(), BeginChildFrame(), ColorConvertU32ToFloat4(), DebugNodeColumns(), DebugNodeStorage(), DebugNodeWindow(), FindWindowFocusIndex(), FindWindowNavFocusable() (+18 more)

### Community 161 - "Community 161"
Cohesion: 0.12
Nodes (26): load_jpeg_image(), stbi__addsizes_valid(), stbi__blinn_8x8(), stbi__cleanup_jpeg(), stbi__compute_y(), stbi__convert_format(), stbi__create_png_image(), stbi__create_png_image_raw() (+18 more)

### Community 162 - "Community 162"
Cohesion: 0.15
Nodes (21): FindNode(), InverseNodeSearch(), ParseCameraChunk(), ParseChunk(), ParseColorChunk(), ParseEditorChunk(), ParseFaceChunk(), ParseHierarchyChunk() (+13 more)

### Community 163 - "Community 163"
Cohesion: 0.1
Nodes (11): Interpolate(), operator ++(), Advance(), BaseGenerator(), Begin(), Clone(), ComputeCurrentValue(), End() (+3 more)
...
Cohesion: 0.11
Nodes (23): GetOutputOfAllCommands(), GTestOutputTest, NormalizeOutput(), NormalizeToCurrentPlatform(), Removes all stack traces from a Google Test program's output., Removes all traces of stack traces from a Google Test program's output., Removes all time information from a Google Test program's output., Removes compiler-specific type info from Google Test program's output.    Args: (+15 more)
...
Cohesion: 0.12
Nodes (25): AddWindowToSortBuffer(), BeginTooltip(), BeginTooltipEx(), ClearDragDrop(), DebugNodeFont(), EndDragDropSource(), EndFrame(), EndTooltip() (+17 more)
...
Cohesion: 0.12
Nodes (24): appendfv(), CallContextHooks(), DestroyContext(), ImFileClose(), ImFileGetSize(), ImFileLoadToMemory(), ImFileRead(), ImFileWrite() (+16 more)

### Community 178 - "Community 178"
Cohesion: 0.13
Nodes (24): AcceptDragDropPayload(), BeginColumns(), Columns(), Draw(), EndColumns(), FindOrAddColumnsSet(), GetColumnOffset(), GetColumnsRectHalfWidth() (+16 more)

### Community 179 - "Community 179"
Cohesion: 0.24
Nodes (22): Assimp_Dump(), ChangeInteger(), CompressBinaryDump(), ConvertName(), encodeXML(), TextureTypeToString(), WriteBinaryAnim(), WriteBinaryBone() (+14 more)

### Community 180 - "Community 180"
Cohesion: 0.14
Nodes (16): Assimp_TestBatchLoad(), main(), aiGetBranchName(), aiGetCompileFlags(), aiGetVersionMajor(), aiGetVersionMinor(), aiGetVersionRevision(), WriteHeaderExtension() (+8 more)

### Community 181 - "Community 181"
Cohesion: 0.13
Nodes (17): Circle, CompositeCurve, Convert(), Ellipse, EstimateSampleCount(), GetParametricRangeDelta(), InRange(), IsClosed() (+9 more)
...
Cohesion: 0.11
Nodes (24): nk_combo(), nk_combo_begin_label(), nk_combo_callback(), nk_combo_end(), nk_combo_item_label(), nk_combo_item_text(), nk_combo_separator(), nk_combo_string() (+16 more)
...
Cohesion: 0.13
Nodes (4): luaIntField(), luaNumField(), luaStrField(), Registry

### Community 189 - "Community 189"
Cohesion: 0.09
Nodes (7): ChecksumTests, CircBufferTests, DeflateInflateTests, DotZLibTests, GZipStreamTests, InfoTests, Utils
...
Cohesion: 0.14
Nodes (15): InternReadFile(), Assimp(), InternReadFile(), IRRMeshImporter(), releaseMaterial(), releaseMesh(), ConvertMappingMode(), ParseMaterial() (+7 more)
...
Cohesion: 0.09
Nodes (7): Peek4(), Take(), Cursor, Eof(), Returns a copy of self., Returns the special cursor to denote the end-of-file., Represents a position (line and column) in a text file.

### Community 196 - "Community 196"
Cohesion: 0.36
Nodes (22): zip_close(), zip_entry_close(), zip_entry_crc32(), zip_entry_fwrite(), zip_entry_index(), zip_entry_name(), zip_entry_open(), zip_entry_size() (+14 more)
...
Cohesion: 0.14
Nodes (22): stbtt_CompareUTF8toUTF16_bigendian(), stbtt_CompareUTF8toUTF16_bigendian_internal(), stbtt__CompareUTF8toUTF16_bigendian_prefix(), stbtt__find_table(), stbtt_FindMatchingFont(), stbtt_FindMatchingFont_internal(), stbtt__GetCoverageIndex(), stbtt_GetFontNameString() (+14 more)

### Community 201 - "Community 201"
Cohesion: 0.11
Nodes (19): dir(), BuildAppearance(), SetAreaConfigMap(), SetAreaMusicMap(), _import_module(), Try import all public attributes from module into global namespace.      Existin, config, databaseConfig (+11 more)
...
Cohesion: 0.18
Nodes (19): Conic, PopulateMeshCache(), ProcessConnectedFaceSet(), ProcessExtrudedArea(), ProcessExtrudedAreaSolid(), ProcessGeometricItem(), ProcessPolygonBoundaries(), ProcessPolyloop() (+11 more)
...
Cohesion: 0.17
Nodes (22): AtomMatchesChar(), CaptureStderr(), CaptureStdout(), CaptureStream(), FormatCompilerIndependentFileLocation(), FormatRegexSyntaxError(), GetCapturedStderr(), GetCapturedStdout() (+14 more)
...
Cohesion: 0.15
Nodes (18): CalculateBounds(), CreateAssetData(), CreateDevice(), CreateHUDTexture(), DeleteAsset(), DeleteAssetData(), GenerateNormalsAsLineList(), LoadAsset() (+10 more)

### Community 213 - "Community 213"
Cohesion: 0.15
Nodes (18): createHelperWindow(), createHiddenCursor(), createKeyTables(), detectEWMH(), getAtomIfSupported(), getSystemContentScale(), _glfwCreateCursorX11(), _glfwGrabErrorHandlerX11() (+10 more)
...
Cohesion: 0.12
Nodes (14): ingame_action_handlers_test.go, TestCombatActionPayloadCodec(), TestInGameActionHandlersIgnoreMalformedPayload(), TestInGameActionHandlersIgnoreWhenActorMissing(), TestPartyActionPayloadCodec(), TestQuestActionPayloadCodec(), TestSkillLoadoutActionPayloadCodec(), Actor (+6 more)
...
Cohesion: 0.2
Nodes (18): CopyValue(), ExportAnimations(), ExportData(), ExportMaterials(), ExportMeshes(), ExportMetadata(), ExportNode(), ExportNodeHierarchy() (+10 more)
...
Cohesion: 0.12
Nodes (20): load_jpeg_image(), stbi__blinn_8x8(), stbi__cleanup_jpeg(), stbi__compute_y(), stbi__compute_y_16(), stbi__convert_format16(), stbi__cpuid3(), stbi__do_zlib() (+12 more)

### Community 226 - "Community 226"
Cohesion: 0.19
Nodes (20): BeginPopup(), BeginPopupContextItem(), BeginPopupContextVoid(), BeginPopupContextWindow(), BeginPopupEx(), BeginPopupModal(), EndPopup(), GetID() (+12 more)
...
Cohesion: 0.12
Nodes (19): AddCustomRectRegular(), AddFontDefault(), AddFontFromMemoryCompressedBase85TTF(), Build(), Decode85(), Decode85Byte(), GetDefaultCompressedFontDataTTFBase85(), GetGlyphRangesDefault() (+11 more)
...
Cohesion: 0.16
Nodes (19): stbi__check_png_header(), stbi__gif_test(), stbi__gif_test_raw(), stbi__hdr_gettoken(), stbi__hdr_info(), stbi__hdr_test(), stbi__hdr_test_core(), stbi_is_hdr_from_callbacks() (+11 more)
...
Cohesion: 0.2
Nodes (17): glfwGetVersion(), glfwGetVersionString(), get_api_name(), get_device_type_name(), get_profile_name_gl(), get_profile_name_glfw(), get_strategy_name_gl(), get_strategy_name_glfw() (+9 more)

### Community 249 - "Community 249"
Cohesion: 0.22
Nodes (15): ApplyDeltaPacket(), ApplyPacket(), ApplySnapshotPacket(), ClampSelection(), IsQuestActiveState(), IsQuestCompletableState(), ObjectiveTypeLabel(), ReadAvailableQuestEntry() (+7 more)
...
Cohesion: 0.13
Nodes (11): now(), Config, MovementValidationConfig, Server, generateSelfSignedCert(), NewServer(), DropEntry, DroppedItem (+3 more)

### Community 252 - "Community 252"
Cohesion: 0.16
Nodes (13): MergeMaterials(), AddBinaryProperty(), AddProperty(), aiGetMaterialColor(), aiGetMaterialFloatArray(), aiGetMaterialIntegerArray(), aiGetMaterialProperty(), aiGetMaterialUVTransform() (+5 more)

### Community 253 - "Community 253"
Cohesion: 0.24
Nodes (17): abortGLInit(), Color4f(), createAILogger(), CreateGLWindow(), destroyAILogger(), drawAiScene(), DrawGLScene(), getBasePath() (+9 more)
...
Cohesion: 0.18
Nodes (18): mz_fopen(), mz_freopen(), mz_zip_add_mem_to_archive_file_in_place(), mz_zip_array_clear(), mz_zip_extract_archive_file_to_heap(), mz_zip_reader_end(), mz_zip_reader_filename_less(), mz_zip_reader_init() (+10 more)
...
Cohesion: 0.17
Nodes (17): stbi__bmp_info(), stbi__check_png_header(), stbi__gif_info(), stbi__gif_info_raw(), stbi__hdr_info(), stbi__hdr_test(), stbi__hdr_test_core(), stbi__info_main() (+9 more)
...
Cohesion: 0.17
Nodes (17): stbi__bitcount(), stbi__bmp_info(), stbi__bmp_load(), stbi__bmp_parse_header(), stbi__bmp_test(), stbi__bmp_test_raw(), stbi__get16le(), stbi__get32le() (+9 more)
...
Cohesion: 0.14
Nodes (17): mz_adler32(), tdefl_calculate_minimum_redundancy(), tdefl_compress(), tdefl_compress_block(), tdefl_compress_fast(), tdefl_compress_lz_codes(), tdefl_compress_normal(), tdefl_find_match() (+9 more)
...
Cohesion: 0.13
Nodes (9): bool, byte, CircularBuffer, DotZLib, CodecBase, DotZLib, GCHandle, IDisposable (+1 more)
...
Cohesion: 0.27
Nodes (16): stbi__bit_reverse(), stbi__bitreverse16(), stbi__compute_huffman_codes(), stbi__err(), stbi__fill_bits(), stbi__parse_huffman_block(), stbi__parse_uncompressed_block(), stbi__parse_zlib() (+8 more)

### Community 285 - "Community 285"
Cohesion: 0.15
Nodes (8): Assimp(), CalcTangentsProcess(), Execute(), ProcessMesh(), CompareBones(), Execute(), UpdateMeshIndices(), ComputePositionEpsilon()

### Community 286 - "Community 286"
Cohesion: 0.18
Nodes (10): AssignMatrixAxes(), Center(), ComputeLastPolygonNormal(), ComputePolygonNormal(), ComputePolygonNormals(), ConvertTransformOperator(), FindVector(), FixupFaceOrientation() (+2 more)
...
Cohesion: 0.15
Nodes (3): Property, JaiDebug, Capacity()

### Community 302 - "Community 302"
Cohesion: 0.19
Nodes (6): Begin(), CreateTestFactory(), End(), IsValidParamName(), ParameterizedTestCaseRegistry(), RegisterTests()

### Community 303 - "Community 303"
Cohesion: 0.26
Nodes (12): Assimp_Export(), GetMatchingFormat(), Assimp_Extract(), DoExport(), SaveAsBMP(), SaveAsTGA(), ExportModel(), FreeLogStreams() (+4 more)
...
Cohesion: 0.13
Nodes (7): ApplicationException, ChecksumGenerator, Codec, DotZLib, Info, ZLibException, uint
...
Cohesion: 0.23
Nodes (14): AddImage(), AddImageQuad(), AddImageRounded(), AddRect(), FixRectCornerFlags(), GetMouseCursorTexData(), _OnChangedTextureID(), PathRect() (+6 more)

### Community 319 - "Community 319"
Cohesion: 0.24
Nodes (14): stbi__compute_transparency(), stbi__compute_transparency16(), stbi__de_iphone(), stbi__expand_png_palette(), stbi__get16be(), stbi__get32be(), stbi__get_chunk_header(), stbi__parse_png_file() (+6 more)
...
Cohesion: 0.29
Nodes (13): WriteBounds(), FilterPolygon(), IntersectsBoundaryProfile(), IntersectSegmentPlane(), PointInPoly(), ProcessBoolean(), ProcessBooleanExtrudedAreaSolidDifference(), ProcessBooleanHalfSpaceDifference() (+5 more)
...
Cohesion: 0.16
Nodes (14): nk_contextual_begin(), nk_input_any_mouse_click_in_rect(), nk_input_is_mouse_click_in_rect(), nk_input_mouse_clicked(), nk_layout_peek(), nk_unify(), nk_widget_bounds(), nk_widget_has_mouse_click_down() (+6 more)
...
Cohesion: 0.18
Nodes (12): Animation(), GetVertexElement(), HasBoneAssignments(), IndexData(), ISubMesh(), Mesh(), MeshXml(), Reset() (+4 more)
...
Cohesion: 0.24
Nodes (9): addTextureMappingModeProperty(), appendChildToParentNode(), CanRead(), CreateDataFromImport(), createMaterials(), createNodes(), createTopology(), createVertexArray() (+1 more)
...
Cohesion: 0.26
Nodes (7): ActorsInRadius(), ApplyDamage(), ApplyHeal(), BroadcastActorDead(), BroadcastEPUpdate(), BroadcastFloatingNumber(), BroadcastHPUpdate()
...
Cohesion: 0.21
Nodes (10): dict, failed(), passed(), read_results_csv(), run(), Uploads the base files (and if necessary, the current ones as well)., GetCommandOutput(), GetShellCommandOutput() (+2 more)

### Community 371 - "Community 371"
Cohesion: 0.23
Nodes (7): AssertHelper(), gtest_internal(), Entity, Field, read(), Schema, Type
...
Cohesion: 0.23
Nodes (10): AddMaterialToDisplayList(), AddTextureToDisplayList(), aiGetMaterialString(), aiGetMaterialTexture(), getUniqueMaterial1(), getUniqueMaterial2(), getUniqueMaterial3(), RemoveRedundantMatsTest (+2 more)
...
Cohesion: 0.22
Nodes (11): AddGlyph(), AddRemapChar(), BuildLookupTable(), CalcCustomRectUV(), FindGlyph(), FindGlyphNoFallback(), GrowIndex(), ImFontAtlasBuildFinish() (+3 more)
...
Cohesion: 0.22
Nodes (7): MakeCone(), MakeDodecahedron(), MakeHexahedron(), MakeIcosahedron(), MakeSphere(), MakeTetrahedron(), Subdivide()
...
Cohesion: 0.2
Nodes (4): Service, testing(), FormatFileLocation(), ReportInvalidTestCaseType()
...
Cohesion: 0.29
Nodes (7): h(), Bind(), DispatchEvents(), RequestState(), RequestStateByName(), RequestStateImpl_(), Update()
...
Cohesion: 0.18
Nodes (11): Camera, MemoryInfo, MeshKey, See 'types.h' for details., See 'vector3.h' for details., See 'anim.h' for details., See 'types.h' for details., See 'camera.h' for details. (+3 more)

### Community 410 - "Community 410"
Cohesion: 0.18
Nodes (10): Matrix3x3, MetadataEntry, NodeAnim, See 'matrix3x3.h' for details., See 'metadata.h' for details, See 'types.h' for details., See 'vector2.h' for details., See 'anim.h' for details. (+2 more)
...
Cohesion: 0.2
Nodes (7): AddChunk(), Clear(), Free(), AssertEq(), GTestUninitializedTest, Runs the given command and verifies its exit code and output., TestExitCodeAndOutput()
...
Cohesion: 0.27
Nodes (10): AddFontFromFileTTF(), AddFontFromMemoryCompressedTTF(), AddFontFromMemoryTTF(), ImFontConfig(), stb_adler32(), stb_decompress(), stb_decompress_length(), stb_decompress_token() (+2 more)

### Community 419 - "Community 419"
Cohesion: 0.2
Nodes (10): AddConvexPolyFilled(), AddPolyline(), AddRectFilledMultiColor(), AddText(), CalcTextSizeA(), CalcWordWrapPositionA(), PrimRectUV(), PrimReserve() (+2 more)
...
Cohesion: 0.22
Nodes (10): stbtt__close_shape(), stbtt_GetCodepointBitmap(), stbtt_GetCodepointBitmapSubpixel(), stbtt_GetCodepointShape(), stbtt_GetGlyphBitmap(), stbtt_GetGlyphBitmapSubpixel(), stbtt_GetGlyphShape(), stbtt__GetGlyphShapeT2() (+2 more)
...
Cohesion: 0.29
Nodes (7): fillTexture(), Material(), Texture(), Video(), Model(), ResolveLinks(), ParseTokenAsString()
...
Cohesion: 0.25
Nodes (7): BuildResult(), Clear(), Clipper, ClipperBase, clipperException, DisposeLocalMinimaList(), DisposeScanbeamList()
...
Cohesion: 0.22
Nodes (4): _glfwPlatformInit(), _glfwPlatformTerminate(), _glfwTerminateOSMesa(), _glfwInitTimerPOSIX()
...
Cohesion: 0.29
Nodes (8): CalcTypematicPressedRepeatAmount(), CalcTypematicRepeatAmount(), ColorConvertHSVtoRGB(), GetKeyPressedAmount(), GetNavInputAmount(), ImFmod(), IsItemClicked(), IsMouseClicked()

### Community 487 - "Community 487"
Cohesion: 0.25
Nodes (6): callCtx, DialogPending, nowMs(), SpellTypeIndex(), SpellAoERow, SpellDef
...
Cohesion: 0.29
Nodes (3): AssbinChunkWriter, AssbinExport, Write()
...
Cohesion: 0.36
Nodes (7): cmp<aiVertexWeight >(), CreateGeometry(), CreateMaterial(), CreateMesh(), SkeletonMeshBuilder(), AssimpBoneWeights(), aiVertexWeight()
...
Cohesion: 0.25
Nodes (8): mz_zip_reader_extract_file_to_callback(), mz_zip_reader_extract_file_to_file(), mz_zip_reader_extract_file_to_mem(), mz_zip_reader_extract_file_to_mem_no_alloc(), mz_zip_reader_filename_compare(), mz_zip_reader_locate_file(), mz_zip_reader_locate_file_binary_search(), mz_zip_reader_string_equal()
...
Cohesion: 0.71
Nodes (6): createTestCharacter(), getSeedQuestID(), openTestDB(), TestQuestAcceptIdempotent(), TestQuestAvailableListLifecycle(), TestQuestFlowAcceptProgressTurnIn()
...
Cohesion: 0.33
Nodes (4): Assimp(), Execute(), TriangulateMesh(), TriangulateProcess()

### Community 538 - "Community 538"
Cohesion: 0.43
Nodes (4): CreateDataFromImport(), CreateMaterial(), CreateMesh(), InternReadFile()
...
Cohesion: 0.29
Nodes (5): CaseInsensitiveCStringEquals(), CStringEquals(), EndsWithCaseInsensitive(), ShouldUseColor(), main()
...
Cohesion: 0.47
Nodes (4): main(), compress(), compress2(), compressBound()
...
Cohesion: 0.4
Nodes (6): AssignIfExist(), CreateSchema(), CreateSchemaRecursive(), GetMember(), GetSchema(), HandleRefSchema()
...
Cohesion: 0.5
Nodes (5): stbtt_GetCodepointBox(), stbtt__GetGlyfOffset(), stbtt_GetGlyphBox(), stbtt__GetGlyphInfoT2(), stbtt_IsGlyphEmpty()
...
Cohesion: 0.7
Nodes (4): ComputeVertexBoneWeightTable(), Execute(), SplitMesh(), UpdateNode()
...
Cohesion: 0.83
Nodes (3): ApplyHorizontalMove(), Update(), UpdateVertical()
...
## Knowledge Gaps
- **736 isolated node(s):** `IncludeHandler`, `serverConfig`, `databaseConfig`, `gameConfig`, `movementConfig` (+731 more)
...
- **Why does `Malloc()` connect `Community 1` to `Community 258`, `Community 4`, `Community 5`, `Community 133`, `Community 6`, `Community 15`, `Community 16`, `Community 280`, `Community 412`, `Community 294`, `Community 309`, `Community 183`, `Community 311`, `Community 60`, `Community 190`, `Community 75`, `Community 331`, `Community 591`, `Community 470`, `Community 472`, `Community 113`, `Community 247`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `Assert()` connect `Community 1` to `Community 514`, `Community 131`, `Community 5`, `Community 6`, `Community 518`, `Community 14`, `Community 15`, `Community 16`, `Community 274`, `Community 277`, `Community 28`, `Community 156`, `Community 412`, `Community 413`, `Community 157`, `Community 32`, `Community 672`, `Community 163`, `Community 552`, `Community 41`, `Community 43`, `Community 174`, `Community 176`, `Community 50`, `Community 441`, `Community 569`, `Community 61`, `Community 447`, `Community 196`, `Community 197`, `Community 333`, `Community 335`, `Community 211`, `Community 219`, `Community 223`, `Community 224`, `Community 354`, `Community 610`, `Community 100`, `Community 107`, `Community 113`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `DeadlyImportError()` connect `Community 48` to `Community 648`, `Community 138`, `Community 13`, `Community 272`, `Community 146`, `Community 147`, `Community 21`, `Community 25`, `Community 538`, `Community 154`, `Community 541`, `Community 30`, `Community 542`, `Community 543`, `Community 33`, `Community 162`, `Community 37`, `Community 165`, `Community 166`, `Community 40`, `Community 171`, `Community 429`, `Community 46`, `Community 47`, `Community 173`, `Community 304`, `Community 433`, `Community 54`, `Community 55`, `Community 696`, `Community 191`, `Community 192`, `Community 69`, `Community 455`, `Community 72`, `Community 73`, `Community 461`, `Community 462`, `Community 206`, `Community 340`, `Community 346`, `Community 91`, `Community 92`, `Community 347`, `Community 227`, `Community 488`, `Community 363`, `Community 492`, `Community 112`, `Community 241`, `Community 498`, `Community 368`, `Community 120`, `Community 254`, `Community 255`?**
...
- **Are the 242 inferred relationships involving `DeadlyImportError()` (e.g. with `ConvertMeshes()` and `InternReadFile()`) actually correct?**
  _`DeadlyImportError()` has 242 INFERRED edges - model-reasoned connections that need verification._
