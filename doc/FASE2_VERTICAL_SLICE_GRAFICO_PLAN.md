...
- [~] Etapa B - Terrain/material quality pass (em fechamento)
- [~] Etapa C - Lighting e atmosfera (iniciada)
...
- knobs centralizados em `dist/client/config.toml` em `[render.character_readability]` (data-driven, sem hardcode espalhado).
